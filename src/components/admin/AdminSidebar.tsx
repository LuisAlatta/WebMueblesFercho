...
export default function AdminSidebar() {
  ...
  return (
    <aside
      className={cn(
        "relative flex flex-col bg-[#1C1C1E] text-white transition-all duration-300 shrink-0",
        collapsed ? "w-16" : "w-56"
      )}
    >
      {/* Logo */}
      ...
      <button
        ...
        className="absolute -right-3 top-20 w-6 h-6 bg-[#1C1C1E] border border-white/20 rounded-full flex items-center justify-center text-white/60 hover:text-white transition-colors"
      >
        {collapsed ? (
